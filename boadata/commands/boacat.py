...
from boadata.cli import try_load, try_apply_sql, try_query, try_select_columns, try_select_rows, try_sort
...
def main(
    ...
    columns: Optional[List[str]] = typer.Option(None, "--column", "-c", help="List of columns to show"),
    ...
    parameter: Optional[List[str]] = typer.Option(None, "--param", "-p", help="Additional parameters for loader, specified as key=value"),
):
